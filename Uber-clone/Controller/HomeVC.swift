...
//        actionButton.setImage(UIImage(named: "baseline_menu_black_36dp")?.withRenderingMode(.alwaysOriginal), for: .normal)
        actionButton.setImage(UIImage(systemName: "figure.walk.circle.fill")?.withRenderingMode(.alwaysOriginal), for: .normal)
    ...
    @objc func actionButtonPressed() {
        ...
        case .dismissActionView:
            ...
            UIView.animate(withDuration: 0.3) {
                ...
                self.configureActionButton(config: .logOut)
...
//            self.actionButton.setImage(UIImage(named: "baseline_menu_black_36dp")?.withRenderingMode(.alwaysOriginal), for: .normal)
            actionButton.setImage(UIImage(systemName: "figure.walk.circle.fill")?.withRenderingMode(.alwaysOriginal), for: .normal)
            self.actionButtonConfiguration = .logOut
        case .dismissActionView:
    ...
    func hideLocationInputView(completion: ((Bool) -> Void)? = nil) {
    ...
    func presentRideActionView(shouldShow: Bool, destination: MKPlacemark? = nil, config: RideActionViewConfiguration? = nil) {
